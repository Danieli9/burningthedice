        ...
        <div class="container-fluid px-20 container-header__home">
            <div class="row g-0">
              ...
              <div class="col-lg-5 header-text__holder order-1 order-lg-2">
			          <h1>BEAT WAGER REQUIREMENTS<br> AND CLAIM YOUR BONUS<br> <span class="emptyClass">GET MY STRATEGY</span></h1>
              </div>
            </div>
        </div>
    </div>
